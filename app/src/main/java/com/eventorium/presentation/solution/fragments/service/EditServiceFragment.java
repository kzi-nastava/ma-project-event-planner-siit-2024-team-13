...
public class EditServiceFragment extends Fragment {
    ...
    private UpdateService loadDataFromForm() {
        try {
            ...
            return UpdateService.builder()
                    ...
                    .cancellationDeadline(Integer.valueOf(String.valueOf(binding.serviceCancellationDeadlineText)))
                    .reservationDeadline(Integer.valueOf(String.valueOf(binding.serviceReservationDeadlineText)))
    ...
    private void fillForm() {
        serviceViewModel.getService(serviceSummary.getId()).observe(getViewLifecycleOwner(), service -> {
            ...
            binding.serviceReservationDeadlineText.setText(service.getReservationDeadline());
            binding.serviceCancellationDeadlineText.setText(service.getCancellationDeadline());
